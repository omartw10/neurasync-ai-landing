...
export default function Founder() {
  ...
  // Focus & Stack Divider
  const botLineScale = useTransform(smoothProgress, [0.35, 0.55], [0, 1]);

  // Focus area
  const focusOpacity = useTransform(smoothProgress, [0.45, 0.65], [0, 1]);
  const focusY = useTransform(smoothProgress, [0.45, 0.65], [20, 0]);

  // Tech stack
  const stackOpacity = useTransform(smoothProgress, [0.55, 0.75], [0, 1]);
  const stackY = useTransform(smoothProgress, [0.55, 0.75], [20, 0]);
  ...
  return (
    <section
      id="founder"
      ref={containerRef}
      className="w-full relative z-10 transition-colors duration-500 bg-white dark:bg-[#030712] py-[100px] md:py-[120px]"
    >
      <div className="relative h-[150vh]">
        {/* Sticky Viewport Container */}
        <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden pt-24 lg:pt-32">



          <motion.div
            style={{ opacity: sectionOpacity }}
            className="max-w-[1100px] mx-auto px-6 grid md:grid-cols-12 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center relative z-20 w-full"
          >
            ...
            <div className="md:col-span-4 lg:col-span-5 flex justify-center md:justify-end perspective-1200">
              ...
              >
                ...
                <div className="relative rounded-[24px] p-[1.5px] bg-gradient-to-tr from-gray-200 dark:from-white/10 to-gray-50 dark:to-transparent shadow-xl dark:shadow-[0_20px_40px_rgba(0,0,0,0.4)] group-hover:shadow-[0_30px_60px_rgba(0,194,209,0.2)] dark:group-hover:shadow-[0_30px_60px_rgba(0,194,209,0.2)] transition-all duration-700 mx-auto md:mx-0">
                  <div className="rounded-[22.5px] overflow-hidden bg-white dark:bg-[#0A101C] aspect-[4/5] w-[180px] md:w-[200px] lg:w-[240px] xl:w-[280px] relative">
                    <img
                    ...
                    <div className="absolute inset-0 border border-black/5 dark:border-white/10 rounded-[22.5px] pointer-events-none z-10 mix-blend-overlay"></div>
            ...
            <div className="md:col-span-8 lg:col-span-7 flex flex-col items-start">
              ...
              >
                <div className="flex items-center gap-3 pb-2">
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-black text-gray-900 dark:text-white tracking-tight leading-none cursor-default">
                    Omar Abutwairat
                  </h2>
                  <a
              ...
              <div className="space-y-3 md:space-y-4 lg:space-y-4 mb-6 text-xs sm:text-sm md:text-sm lg:text-base text-gray-600 dark:text-gray-400 font-medium leading-relaxed">
                <motion.p style={{ opacity: p1Opacity, y: p1Y }}>
                  Omar Abutwairat is a software engineer specializing in AI-powered automation systems, workflow orchestration, and scalable digital infrastructure. He builds intelligent systems that transform how companies handle operations and decision flows.
                </motion.p>
                <motion.p style={{ opacity: p2Opacity, y: p2Y }}>
                  By combining AI classification models with modern web architecture, Omar designs production-grade automation pipelines. His work turns fragmented manual processes into cohesive ecosystems, allowing businesses to process information faster and scale efficiently.
                </motion.p>
              </div>
