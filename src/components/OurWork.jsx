...
const BentoCard = ({ children, className }) => {
  ...
  return (
    ...
    >
      ...
      />
      {/* Content Container */}
      <div className="relative z-10 w-full h-full p-5 sm:p-6 lg:p-8 flex flex-col">
        {children}
      </div>
    </div>
  );
...
const MergedPlatformStudio = () => {
  ...
  return (
    <section
      ...
      ref={containerRef}
      className="relative min-h-[100svh] flex flex-col justify-center scroll-mt-24 md:scroll-mt-32 px-6 sm:px-12 lg:px-24 xl:px-40 pb-16 pt-[120px] text-gray-900 dark:text-white overflow-hidden"
    >
      {/* ===== Section Header ===== */}
      <div className="merged-header text-center max-w-4xl mx-auto mb-10 w-full relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#00C2D1]/10 border border-[#00C2D1]/20 text-[#00C2D1] text-[10px] sm:text-[11px] font-bold tracking-[0.2em] uppercase mb-4 sm:mb-6">
          <Sparkles className="w-3.5 h-3.5" /> Platform & Studio
        </div>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold leading-[1.1] mb-3">
          Unleash the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-[#00C2D1]">AI Potential</span><br className="hidden sm:block" />
          inside your operations.
        </h2>
        <p className="text-gray-400 text-xs sm:text-sm md:text-sm max-w-xl mx-auto mb-4 leading-relaxed font-medium">
      ...
      {/* ===== Bento Grid Layout ===== */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 max-w-[1100px] mx-auto z-10 relative w-full">
            ...
            <div className="flex-1 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-center mb-4">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#00C2D1] to-blue-600 flex items-center justify-center shadow-lg">
                    <Mailbox className="w-5 h-5 text-white" strokeWidth={1.5} />
                  </div>
                  <span className="px-3 py-1 text-[10px] font-bold uppercase tracking-widest rounded-full bg-[#00C2D1]/10 text-[#00C2D1] border border-[#00C2D1]/20">
                    Flagship Product
                  </span>
                </div>
                <h3 className="text-xl md:text-2xl font-bold mb-2 tracking-tight">InboxPilot AI</h3>
        ...
        <BentoCard className="lg:col-span-4 group relative overflow-hidden bg-gradient-to-b from-gray-50 to-white dark:from-[#0E1624] dark:to-[#060D18]">
          <div className="flex flex-col h-full justify-between">
            <div>
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-2 tracking-tight">Custom AI Studio</h3>
              <p className="text-gray-600 dark:text-gray-400 text-xs md:text-sm leading-relaxed mb-6">
        ...
        <BentoCard className="lg:col-span-6 group">
          <div className="flex flex-col sm:flex-row gap-6 h-full items-start sm:items-center justify-between">
            <div className="flex-1 pr-4">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-2">LeadSync AI</h3>
        ...
        <BentoCard className="lg:col-span-6 group">
          <div className="flex flex-col sm:flex-row gap-6 h-full items-start sm:items-center justify-between">
            <div className="flex-1 pr-4">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-2">DocuExtract AI</h3>
              <p className="text-gray-600 dark:text-gray-400 text-xs md:text-sm leading-relaxed">
